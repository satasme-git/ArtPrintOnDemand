...
$rst=mysqli_query($conn,$query);
							if($rst){
								while ($var=mysqli_fetch_assoc($rst)) {
									...
									$tbl.="<td><a href='#?id={$var['id']}' onclick=\"return confirm('Are you sure?');\"><p class=\"text-danger\">Edit</p></a></td>";
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><b>Add New Category</b>
</h5>
                        ...
                        <div class="panel-heading">
                        <h5 class="panel-title"><b> Category List</b>
</h5>
                        </div>
                        <table class="table">
