...
$query="SELECT * FROM category where mainid=0 ORDER BY name DESC";
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal form-validate-jquery" action="category.php" method="POST" enctype="multipart/form-data">
