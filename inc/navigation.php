<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Customer -->
								<li class="navigation-header"><span>Customer</span> <i class="icon-menu" title="Tables"></i></li>
								<li>
									<a href="#"><i class="icon-table2"></i> <span> Customer components</span></a>
									<ul>
										<li><a href="view_customer.php">View Customer List</a></li>
										<!-- <li><a href="table_sizing.html">Table sizing</a></li>
										<li><a href="table_borders.html">Table borders</a></li>
										<li><a href="table_styling.html">Table styling</a></li>
										<li><a href="table_elements.html">Table elements</a></li> -->
								...
								<!-- Forms -->
								<li class="navigation-header"><span>Frames</span> <i class="icon-menu" title="Forms"></i></li>
								<li>
									<a href="#"><i class="icon-pencil3"></i> <span>Frames components</span></a>
									<ul>
								...
								<li>
									...
									<ul>
										...
										<li><a href="login_registration.php">User registration</a></li>
